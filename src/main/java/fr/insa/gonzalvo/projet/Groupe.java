...
public class Groupe extends Figure {
    ...
    public static Groupe groupeTest() {
        ...
        Segment_Terrain s1 = new Segment_Terrain(p1, p2);
        Segment_Terrain s2 = new Segment_Terrain(p2, p3);
        Segment_Terrain s3 = new Segment_Terrain(p3, p1);
        Segment_Terrain s4 = new Segment_Terrain(p1, p4);
    ...
    public void menuTexte() {
        ...
        while (rep != 0) {
            ...
            if (rep == 1) {
                ...
                Segment_Terrain ns = Segment_Terrain.demandeSegment();
                this.add(ns);
            } else if (rep == 4) {
                ...
                if (deb != null) {
                    ...
                    Segment_Terrain ns = new Segment_Terrain(deb, fin);
                    this.add(ns);
                }
            } else if (rep == 5) {
    ...
    public static void exempleProblemeSauvegarde() {
        ...
        Segment_Terrain s11 = new Segment_Terrain(p11, p12);
        Segment_Terrain s12 = new Segment_Terrain(p13, p14);
        ...
        Segment_Terrain s21 = new Segment_Terrain(p21, p22);
        Segment_Terrain s22 = new Segment_Terrain(p22, p24);
