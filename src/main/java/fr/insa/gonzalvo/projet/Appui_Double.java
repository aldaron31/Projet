...
public class Appui_Double extends Appui {
    ...
    public Appui_Double(Triangle_Terrain TT, int numPoint1, int numPoint2, double posSeg) {
        super.setTT(TT);
    ...
    public Appui_Double(Triangle_Terrain TT, int numPoint1, int numPoint2, double posSeg, Color col) {
        this.couleur = col;
        super.setTT(TT);
        super.setNumPoint1(numPoint1);
        super.setNumPoint2(numPoint2);
    ...
    public void save(Writer w, Numeroteur<Noeuds> numN, Numeroteur<Triangle_Terrain> numTT) throws IOException {
        if(! numN.objExist(this)) {
            ...
            w.append("Appui_Double;"+id+";"+numTT.getID(super.getTT())+";"+super.getNumPoint1()+
